...
public class DisplayMessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestQueue = Volley.newRequestQueue(DisplayMessageActivity.this);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DisplayMessageActivity.this, RecyclerView.VERTICAL, false);
    ...
    private void sendMessage(String userMsg) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DisplayMessageActivity.this, "No response from the bot..", Toast.LENGTH_SHORT).show();
            }
        });
